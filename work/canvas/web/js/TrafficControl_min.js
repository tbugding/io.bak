...
(function () {
    ...
    g.prototype.initialize = function (l) {
        var j = d("div", {title: "显示交通流量", id: "tcBtn", "class": "maplibTcBtn" + h + " maplibTcBtnOff" + h});
    ...
    g.prototype._popUpDiv = function (F, w) {
        ...
        function C(J) {
            ...
            function I() {
                ...
                J.showTraffic({predictDate: {hour: J.hour, weekday: J.weekday}})
            }
        ...
        function m(I) {
            a.event.on("tcWeek", "onclick", function (L) {
                ...
                if (K.tagName.toLowerCase() == "a") {
                    ...
                    q();
                    I.showTraffic({predictDate: {hour: I.hour, weekday: I.weekday}})
                }
            })
        }
        ...
        function E(M) {
            ...
            function I() {
                ...
                M.showTraffic({predictDate: {hour: M.hour, weekday: M.weekday}})
            }
    ...
    function f(k, j, l) {
        ...
        j = {"for": "htmlFor", "class": "className"}[j] || j;
    ...
    function d(l, k) {
        ...
        return n;
        function j() {
            var o = {cellpadding: "cellPadding", cellspacing: "cellSpacing", colspan: "colSpan", rowspan: "rowSpan", valign: "vAlign"};
            if (a.browser.ie < 8) {
                o["for"] = "htmlFor";
                o["class"] = "className"
            } else {
