...
function rnd(n,m){	//取随机数
	return parseInt(Math.random()*(m-n+1)+n);
}
function isInArry(n,arr){	//数组里是否有某个数
	...
	function drag(obj){	//拖拽和换位
		...
		oBlock.onmousedown=function(e){
			...
			document.onmousemove=function(e){
				//计算当前托拽块的状态（拖动）
				var oEvent=e||event;
				var l=oEvent.clientX-disX-oldL;
				var t=oEvent.clientY-disY-oldT;
